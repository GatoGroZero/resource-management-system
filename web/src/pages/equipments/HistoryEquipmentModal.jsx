...
import { getReservationsByEquipment } from '../../api/reservationApi'

function HistoryEquipmentModal({ equipment, onClose }) {
  ...
  useEffect(() => {
    if (equipment?.id) {
      setLoading(true)
      getReservationsByEquipment(equipment.id)
        ...
        <div style={headerStyle}>
          <div>
            ...
            <div style={subtitleRowStyle}>
              ...
              <span style={subtitleStyle}>{equipment.name}</span>
            </div>
          </div>
        ...
        <div style={bodyStyle}>
          ...
          {!loading && history.length === 0 && (
            <div style={emptyBlockStyle}>
              ...
              <p style={emptyStyle}>Este equipo no tiene registros de reservas previas.</p>
            </div>
          )}
...
export default HistoryEquipmentModal